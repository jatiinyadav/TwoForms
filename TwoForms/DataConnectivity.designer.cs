...
namespace TwoForms
{
	...
	public partial class DataConnectivityDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteEmployee(Employee instance);
		...
		public DataConnectivityDataContext() : 
				base(global::TwoForms.Properties.Settings.Default.myDatabaseConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DataConnectivityDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataConnectivityDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataConnectivityDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataConnectivityDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCreated();
    partial void OnemoChanging(int value);
    partial void OnemoChanged();
    ...
    partial void OnDnameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_emo", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int emo
		{
			get
			{
			...
			set
			{
				if ((this._emo != value))
				{
					this.OnemoChanging(value);
					this.SendPropertyChanging();
					this._emo = value;
					this.SendPropertyChanged("emo");
					this.OnemoChanged();
				}
			}
		}
